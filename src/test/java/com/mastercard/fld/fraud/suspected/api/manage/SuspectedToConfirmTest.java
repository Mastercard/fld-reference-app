...
import com.mastercard.fld.fraud.suspected.api.manage.issuer.IssuerSuspectedToConfirm;
...
public class SuspectedToConfirmTest {

    @InjectMocks
    @Spy
    IssuerSuspectedToConfirm suspendToConfirm;
