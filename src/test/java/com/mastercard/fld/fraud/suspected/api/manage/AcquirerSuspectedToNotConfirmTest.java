...
import com.mastercard.fld.fraud.suspected.api.manage.acquirer.AcquirerSuspectedToNotConfirm;
...
public class AcquirerSuspectedToNotConfirmTest {

    @InjectMocks
    @Spy
    AcquirerSuspectedToNotConfirm suspendToNotConfirm;
