...
import com.mastercard.fld.fraud.suspected.api.manage.acquirer.AcquirerSuspectedToConfirm;
...
public class AcquirerSuspectedToConfirmTest {

    @InjectMocks
    @Spy
    AcquirerSuspectedToConfirm suspendToConfirm;
