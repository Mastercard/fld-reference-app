...
public class EncryptionHelper {
    ...
    private static Certificate getEncryptionCertificate(String filePath) throws IOException, CertificateException {
        ...
        return EncryptionUtils.loadEncryptionCertificate(file.getPath());
    }

    public static FieldLevelEncryptionConfig encryptionConfig(String encryptioncert, String fingerprint) throws EncryptionException {
