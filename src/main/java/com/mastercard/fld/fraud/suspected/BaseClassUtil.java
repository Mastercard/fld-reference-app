...
public class BaseClassUtil {
    ...
    private static final String END_POINT = "mastercard.fld.suspected.client.ref.app.endpoint";
    private static final String CONSUMER_KEY = "mastercard.fld.suspected.client.ref.app.consumer.key";
    private static final String KEYSTORE_PATH = "mastercard.fld.suspected.client.p12.path";
    private static final String KEYSTORE_ALIAS = "mastercard.fld.suspected.client.ref.app.keystore.alias";
    private static final String KEYSTORE_PASS = "mastercard.fld.suspected.client.ref.app.keystore.password";
    private static final String ENCRYPTION_CERT = "mastercard.fld.suspected.client.ref.app.encryption.file";
    private static final String ENCRYPTION_KEY = "mastercard.fld.suspected.client.ref.app.encryption.key";
